...
exports.loginUser = function(req, res) {
  ...
  User.findOne( {username: username}, function( err, foundUser ) {
    if( !foundUser.id ) { // user not found
      res.redirect( '/login' );
...
exports.signupUser = function(req, res) {
  ...
  User.findOne( {username: username}, function( err, foundUser ) {
    if( !foundUser.id ) { // assume that if a user isn't found this doesn't exist?
      User.create( req.body, function( err, newUser ) {
        // newUser is created, let's hash that password!
        User.hashPassword( newUser.id, function() {
          // Password is hashed, let's log our new user in.
